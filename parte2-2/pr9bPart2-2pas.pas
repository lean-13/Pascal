...
procedure AlumnoF;
	...
	begin
		writeln('Ingrese numero de inscripción: ');
			...
			Min(NrInscripcion, NrMin1, NrMin2, Apellido, NrMinAlum1, NrMinAlum2);
			Max(NrInscripcion, NrMax1, NrMax2, Nombre, NrMaxAlum1, NrMaxAlum2);
			Par(NrInscripcion, NrInscripcionPar);

	end;
procedure Min(var NrInscripcion, NrMin1, NrMin2: integer; Apellido, NrMinAlum1, NrMinAlum2: string);
begin
	// minimo
...
procedure Max(var NrInscripcion, NrMax1, NrMax2: integer; Nombre, NrMaxAlum1, NrMaxAlum2: string);
begin
...
procedure Par(var NrInscripcion, NrInscripcionPar: integer);
begin
